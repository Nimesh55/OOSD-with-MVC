...
<body>
    ...
    <h1>SAFE TRANSIT</h1>
        <form action="includes/login.inc.php" method="post">            
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="submit">Log In</button></div><div class="sign_up">Don't have account? <a href="passenger_signup.php" class="signup"> Sign up here</a></div></form>
    </div>
